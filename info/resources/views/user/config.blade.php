        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                <form method="POST" action="{{route('user.update')}}" aria-label="{{ __('Update') }}" enctype="multipart/form-data" class="p-3 mb-2 bg-dark text-white">
                        @csrf
                        <div class="form-group row">
                                <label for="image" class="col-md-4 col-form-label text-md-right">{{ __('Image') }}</label>

                                <div class="col-md-6">
                                    <input id="image" type="file" class="form-control{{ $errors->has('image') ? ' is-invalid' : '' }}" name="image" required autofocus>
